    ...
    <body>
        ...
        <section class="section-features js--section-features" id="features">
            ...
            <div class="row js--wp-1">
                <div class="col span-1-of-4 box">
                    <i class="icon ion-ios-calendar icon-big"></i>
        ...
        <section class="section-steps" id="works">
            ...
            <div class="row">
                <div class="col span-1-of-2 steps-box">
                    <img src="assets/img/app-iPhone.png" alt="Onmifood App on iPhone" class="app-screen js--wp-2">
                </div>
                <div class="col span-1-of-2 steps-box">
                    ...
                    <a href="#" class="btn-app"><img src="assets/img/download-app.svg" alt="App Store Button"></a>
                    <a href="#" class="btn-app"><img src="assets/img/download-app-android.png" alt="Play Store Button"></a>
                </div>
            </div>
        </section>
        ...
        <section class="section-cities" id="cities">
            ...
            <div class="row js--wp-3">
                <div class="col span-1-of-4 box">
                    <img src="assets/img/chicago.jpg" alt="Chicago">
                    <h3>Chicago</h3>
                    ...
                    <div class="city-feature">
                        ...
                        <a href="#">@omnifood_chi</a>
                    </div>
                </div>
                <div class="col span-1-of-4 box">
                    <img src="assets/img/los-angeles.jpg" alt="Los Angeles">
                    <h3>Los Angeles</h3>
                    <div class="city-feature">
                        <i class="icon ion-ios-person icon-small"></i>
                        3700+ happy eaters
            ...
            <div class="row">
                <div class="col span-1-of-3">
                    <blockquote>
                        ...
                        <cite><img src="assets/img/customer-1.jpg" alt="Customer 1">Alberto Duncan</cite>
                    </blockquote>
                </div>
                <div class="col span-1-of-3">
                    <blockquote>
                        Inexpensive, healthy and great-tasting meals, delivered right to my home. We have lots of food delivery here in New York, but no one comes even close to Omifood. Me and my family are so in love!
                        <cite><img src="assets/img/customer-2.jpg" alt="Customer 1">Joana Silva</cite>
                    </blockquote>
                </div>
                <div class="col span-1-of-3">
                    <blockquote>
                        I was looking for a quick and easy food delivery service in San Franciso. I tried a lot of them and ended up with Omnifood. Best food delivery service in the Bay Area. Keep up the great work!
                        <cite><img src="assets/img/customer-3.jpg" alt="Customer 1">Milton Chapman</cite>
                    </blockquote>
                </div>
            </div>
        </section>
